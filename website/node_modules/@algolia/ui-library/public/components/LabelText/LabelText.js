...
const renderChildren = (children, required, optional) => {
    ...
    return react_1.Children.map(children, (item, index) => {
        if ((optional || required) &&
            ...
            index === 0) {
            return (react_2.jsx(react_1.Fragment, null,
                item,
                react_2.jsx("span", { className: "uil-ff-poppins uil-fw-semibold uil-ml-8 uil-lsp-normal uil-tt-lower uil-color-nova uil-d-inline-block" }, content())));
        }
        return item;
    });
};
...
const LabelText = ({ big = false, children, color = 'grey', font = 'poppins', icon: CustomIconTag, iconProps = {}, optional = false, required = false, tag = 'span', ...other }) => {
    ...
    return (react_2.jsx(CustomTag, Object.assign({}, otherProps, { className: classnames_1.default('uil-tt-upper uil-fw-semibold uil-lsp-big', font === 'poppins' ? 'uil-ff-poppins' : 'uil-ff-jetbrains', COLORS[color], CustomIconTag && 'uil-d-flex uil-ai-center', big ? 'uil-fsz-14 lg:uil-fsz-16' : 'uil-fsz-11 lg:uil-fsz-12', otherClassName) }),
        CustomIconTag && (react_2.jsx(CustomIconTag, Object.assign({}, otherIconProps, { className: classnames_1.default('uil-mr-8 uil-w-18 uil-h-18 uil-fxs-0 lg:uil-w-24 lg:uil-h-24', iconClassName) }))),
