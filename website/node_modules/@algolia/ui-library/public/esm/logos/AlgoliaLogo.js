...
const AlgoliaLogo = ({ onContextMenu, ...other }) => (jsx("svg", Object.assign({}, other, { xmlns: "http://www.w3.org/2000/svg", width: "485", height: "120", viewBox: "0 0 485 120", onContextMenu: (e) => {
        if (onContextMenu)
            onContextMenu(e);
    } }),
