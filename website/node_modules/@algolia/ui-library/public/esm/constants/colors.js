const config = require('../fragments/fragments');
export const WHITE = config.colors.white;
export const TRANSPARENT = config.colors.transparent;
// New synapse colors
export const GREY_050 = config.colors['grey-050'];
...
export const COLOR_PREDICT = config.colors['color-predict'];
export const COLOR_ANSWER = config.colors['color-answer'];
export const COLOR_RECOMMEND = config.colors['color-recommend'];
