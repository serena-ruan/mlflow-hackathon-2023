...
import styles from './LightCta.css';
const COLORS = {
...
const LightCta = ({ children, color = 'blue', hoverEffect = false, tag = 'span', withArrow = true, withTail = false, ...other }) => {
    ...
    return (jsx(CustomTag, Object.assign({}, otherProps, { className: cx(`uil-d-inline-flex uil-ai-center uil-td-none hover:uil-td-none`, COLORS[color], otherClassName), "data-with-tail-cta": withTail }),
        withTail && (jsx("span", { className: cx('uil-mr-8 uil-fxs-0 uil-pos-relative uil-bgc-current', hoverEffect ? 'uil-w-30' : 'uil-w-20'), css: styles.tail })),
        jsx(LabelText, { color: color, className: "uil-fxs-1" }, children),
        withArrow && (jsx(Play, { name: "triangle-right", className: "uil-ml-8 uil-fxs-0 uil-pos-relative", fill: "currentColor", css: styles.arrow }))));
};
