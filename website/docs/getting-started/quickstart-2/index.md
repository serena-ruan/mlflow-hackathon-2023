# Quickstart: Compare runs, choose a model, and deploy it to a REST API {#quickstart-mlops}
...
## Serve the model locally {#serve-the-model-locally}
...
This command builds a Docker image named `qs_mlops` that contains your
