# Logging our first runs with MLflow {#logging-our-first-runs-with-mlflow}
...
<figure>
<img
src="../../../static/images/tutorials/introductory/logging-first-model/dogfood.gif"
class="align-center" width="1024"
alt="../../../static/images/tutorials/introductory/logging-first-model/dogfood.gif" />
<figcaption>Validating the results of a training run in the MLflow
UI</figcaption>
</figure>
...
<figure>
<img
src="../../../static/images/tutorials/introductory/logging-first-model/cleanup-experiments.gif"
class="align-center" width="1024"
alt="../../../static/images/tutorials/introductory/logging-first-model/cleanup-experiments.gif" />
<figcaption>Removing experiments that were filled with failed
attempts</figcaption>
</figure>
...
If you're precisely following along to this tutorial and you delete your
`Apple_Models` Experiment, recreate it before proceeding to the next
step in the tutorial.

</div>

## Using MLflow Tracking to keep track of training {#using-mlflow-tracking-to-keep-track-of-training}
...
To aid in visualizing how MLflow tracking API calls add in to an ML
training code base, see the figure below.

<figure>
<img
src="../../../static/images/tutorials/introductory/logging-first-model/training-annotation.svg"
class="align-center" width="1024"
alt="../../../static/images/tutorials/introductory/logging-first-model/training-annotation.svg" />
</figure>
...
<figure>
<img
src="../../../static/images/tutorials/introductory/logging-first-model/logging-first-model.gif"
class="align-center" width="1024"
alt="../../../static/images/tutorials/introductory/logging-first-model/logging-first-model.gif" />
</figure>
